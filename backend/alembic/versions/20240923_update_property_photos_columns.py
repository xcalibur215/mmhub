...
def upgrade() -> None:
    ...
    op.add_column(
        "property_photos", sa.Column("display_order", sa.Integer(), server_default="0")
    )
    op.add_column(
        "property_photos",
    ...
    op.add_column(
        "property_photos", sa.Column("file_size", sa.Integer(), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "property_photos", sa.Column("order_index", sa.Integer(), server_default="0")
    )
